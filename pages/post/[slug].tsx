    ...
    <main>
        ...
        <article className='max-w-3xl mx-auto p-5'>
            ...
            <div className='flex items-center space-x-2'>
                ...
                <p className='font-extralight text-sm'>Blog post by <span className='text-purple-700'>{post.author.name}</span> - Published at {""} 
        ...
        <div className='flex flex-col p-10 my-10 max-w-2xl mx-auto shadow-purple-600 shadow space-y-2'>
            <h3 className='text-4xl'>Comments</h3>
            <hr className='pb-2'/>

            {post.comments.map((comment) => (
                <div key={comment._id}>
                    <p><span className='text-purple-700'>{comment.name}:</span> {comment.comment}</p>
                </div>
            ))}
        </div>
    </main>
